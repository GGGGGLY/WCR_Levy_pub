# -*- coding: utf-8 -*-
"""
Created on Sun May 21 15:01:32 2023
...
class DataSet(object):
    def __init__(self, time_instants, true_dt, samples_num, dim, drift_term, xi_term, alpha_levy,
...
if __name__ == '__main__':
    ...
    dataset = DataSet(torch.linspace(0, 10, 10001), true_dt=0.1, samples_num=2000, dim=2,
                      drift_term=drift, xi_term = xi, alpha_levy = 1.999, initialization=torch.rand(2000, 2) + 1,
