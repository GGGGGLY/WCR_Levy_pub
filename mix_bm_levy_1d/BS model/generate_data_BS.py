...
if __name__ == '__main__':
    ...
    label = "Gaussian"
    dataset = DataSet(torch.tensor([0, 1, 5]), dt=0.001, samples_num=10000, dim=1, drift_term=drift, 
                      diffusion_term=diffusion, alpha_levy = 3/2, initialization=torch.normal(0, 0.2,[10000, 1]), label = label,
