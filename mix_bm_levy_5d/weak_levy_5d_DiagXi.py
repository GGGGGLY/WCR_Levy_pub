...
from gen_data.GenerateData_n import DataSet
...
if __name__ == '__main__':
    ...
    t = torch.tensor(t)
    dim = 5
    #Xi_type = "cI" # Diagonal matrices with the same diagonal elements
    Xi_type = "Diag" # The diagonal elements are estimated separately
