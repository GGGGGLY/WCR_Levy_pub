...
if __name__ == '__main__':
    ...
    model.compile(basis_order=3,basis_xi_order=1, gauss_variance=0.73, type='LMM_2_nonequal', drift_term=drift, diffusion_term=diffusion, xi_term=xi,
    ...
    '''
    Interpolation distribution for initial SDE
    '''
    ...
    plt.legend()
    plt.title("Distribution of interpolation: t=0.75")
    plt.show()
