# -*- coding: utf-8 -*-
"""
Created on Tue Sep 12 17:35:53 2023
...
class Model(object):
    ...
    @utils.timing
    def compile(self, basis_order, gauss_variance, type, drift_term, xi_term, gauss_samp_way, lhs_ratio):
    ...
    def train(self, gauss_samp_number, lam, STRidge_threshold):
        ...
        for i in range(self.zeta.numel()-2):
...
if __name__ == '__main__':
    ...
    model.compile(basis_order=3, gauss_variance=1.3, type='LMM_2_nonequal', drift_term=drift, xi_term=xi,\
                  gauss_samp_way='lhs', lhs_ratio=1.0)
    model.train(gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2)
...
# Drift term:  [0.] + [1.0958256]x^1 + [0.]x^2 + [-1.0511613]x^3
#Diffusion term of Levy Noise:  tensor([1.2754])
#Maximum relative error:  0.27541542
#train' took 0.839987 s

##########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.0, lhs = 1
# Drift term:  [0.] + [0.9937118]x^1 + [0.]x^2 + [-1.0138408]x^3
#Diffusion term of Levy Noise:  tensor([1.2758])
#Maximum relative error:  0.27577555
#'train' took 0.920941 s

##########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.2, lhs = 1
# Drift term:  [0.] + [1.1406709]x^1 + [0.]x^2 + [-1.0721698]x^3
#Diffusion term of Levy Noise:  tensor([1.2468])
#Maximum relative error:  0.24682522
#'train' took 0.862212 s

##########sample = 10000, gauss_samp_number=70, lam=0.001, STRidge_threshold=0.2, gauss_var = 1.2, lhs = 1
#Drift term:  [0.] + [1.1374186]x^1 + [0.]x^2 + [-1.0648491]x^3
#Diffusion term of Levy Noise:  tensor([1.2455])
#Maximum relative error:  0.24553132
#'train' took 1.035966 s

##########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.4, lhs = 1
# Drift term:  [0.] + [1.3294488]x^1 + [0.]x^2 + [-1.144815]x^3
#Diffusion term of Levy Noise:  tensor([1.2157])
#Maximum relative error:  0.32944882
#'train' took 0.857114 s

##########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.2, lhs = 0.7
#Drift term:  [0.] + [1.1242043]x^1 + [0.]x^2 + [-1.0735124]x^3
#Diffusion term of Levy Noise:  tensor([1.2653])
#Maximum relative error:  0.2652589
#'train' took 0.778744 s

##########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.4, lhs = 0.7
#Drift term:  [0.] + [1.2587771]x^1 + [0.]x^2 + [-1.1212019]x^3
#Diffusion term of Levy Noise:  tensor([1.2379])
#Maximum relative error:  0.25877714
#'train' took 0.941535 s


##########sample = 10000, gauss_samp_number=50, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.2, lhs = 1.2
#Drift term:  [0.] + [1.154833]x^1 + [0.]x^2 + [-1.0694388]x^3
#Diffusion term of Levy Noise:  tensor([1.2419])
#Maximum relative error:  0.24192
#'train' took 0.760593 s

##########sample = 10000, gauss_samp_number=50, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.2, lhs = 1.0
#Drift term:  [0.] + [1.1322831]x^1 + [0.]x^2 + [-1.0613681]x^3
#Diffusion term of Levy Noise:  tensor([1.2445])
#Maximum relative error:  0.2444973
#'train' took 0.765150 s

##########sample = 10000, gauss_samp_number=50, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.4, lhs = 1.0
# Drift term:  [0.] + [1.3293734]x^1 + [0.]x^2 + [-1.1409872]x^3
#Diffusion term of Levy Noise:  tensor([1.2146])
#Maximum relative error:  0.32937336
#'train' took 0.551207 s


##########sample = 10000, gauss_samp_number=100, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.3, lhs = 1.0
# Drift term:  [0.] + [1.2112255]x^1 + [0.]x^2 + [-1.0974027]x^3
#Diffusion term of Levy Noise:  tensor([1.2346])
#Maximum relative error:  0.23460579
#'train' took 1.190054 s
   
#------------------------------------
########sample = 10000, gauss_samp_number=70, lam=0.0, STRidge_threshold=0.2, gauss_var = 1.3, lhs = 1
#Drift term:  [0.] + [1.2315031]x^1 + [0.]x^2 + [-1.1073295]x^3
#Diffusion term of Levy Noise:  tensor([1.2312])
#Maximum relative error:  0.23150313
#'train' took 0.808633 s
#------------------------------------
