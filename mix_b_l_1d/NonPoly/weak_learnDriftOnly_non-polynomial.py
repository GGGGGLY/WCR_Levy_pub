...
if __name__ == '__main__':
    ...
    dataset = DataSet(t, dt=0.0001, samples_num=samples, dim=1, xi_term=xi, alpha_levy = 3/2, \
                      ...
                      #initialization=torch.randint(-1000,1000,[10000, 1])   initialization=torch.normal(0, 0.2,[samples, 1])
    ...
    model.compile(basis_order=9, gauss_variance=0.55, type='LMM_2_nonequal', xi_term=xi,\
    ...
    plt.legend(['True', '9-th'], fontsize=13)  
